...
def train_lora(
    ...
    model_dir: str = "models/roberta_lora",
    ...
    if not PEFT_AVAILABLE:
        print("❌ peft 套件未安裝，無法使用 LoRA")
        return
    
    print("🚀 開始訓練 RoBERTa + LoRA 模型...")
    ...
    print("📥 載入 RoBERTa tokenizer 和模型...")
    ...
    # 設定 LoRA
    print(f"🔧 設定 LoRA (rank={lora_rank}, alpha={lora_alpha})...")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="訓練 RoBERTa + LoRA 模型")
    parser.add_argument("--data", type=str, default="AI_Human.csv", help="資料路徑")
    parser.add_argument("--model_dir", type=str, default="models/roberta_lora", help="模型目錄")
    parser.add_argument("--base_model", type=str, default="roberta-base", help="基礎模型")
